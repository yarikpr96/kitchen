...
<div id="tooplate_wrapper" style="overflow: auto;height: 300%">
    <div class="clear"></div>
    <div id="tooplate_wrapper5">
        <p style="font-size: 20px ;text-align: center;color: #67acc2;font-family: Tahoma, Geneva, sans-serif;margin-top: 5px;	">
            Продукти в яких минає термін придантності
        </p>
    </div>

    <c:forEach items="${endKitchen}" var="a">
        ...
        <div class="col one_third gallery_box">
            ...
            <a href="/kitchenEdit/${a.id_p}">
                <button type="submit">Модифікувати</button>
            </a>
                <%--</sec:authorize>--%>
            <p>
                    <%--<sec:authorize access="hasRole('ADMIN')">--%>
                    <%--<form:form action="/kitchen/delete/${a.id_p}" method="post">--%>
