...
<div id="tooplate_wrapper" style="height: auto">
    ...
    <c:forEach items="${aproduct}" var="a">
        ...
        <div class="col one_third gallery_box">
            ...
            <a href="/aproductEdit/${a.id_ap}">
                <button type="submit">Модифікувати</button>
            </a>
                </sec:authorize>
            <p>
                    <sec:authorize access="hasRole('ADMIN')">
                <form:form action="/aproduct/delete/${a.id_ap}" method="post">
            ...
            <p>
                <a href="/aproduct/${a.id_ap}">Додати в кухню</a>
            </p>
                </sec:authorize>
                <sec:authorize access="hasRole('ADMIN')">
            <p>
                <a href="/productres/${a.id_ap}">Додати в рецепти</a>
            </p>
                </sec:authorize>
        </div>
